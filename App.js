...
/* 
   ...
   Programmer: Ryan Skarnulis
   Description: This function connects to a cobot and checks what mode it is in.
      If it is not in the correct mode it stores error data in the error table.
*/
...
ws.onopen = function(evt) {
    ...
    ws.onmessage = function(evt) {
      if(ab2str(evt.data) == 0){
        ...
        else{//var data = String.fromCharCode.apply(null, new Uint16Array(evt.data));
...
//let interval; // Added by Ryan to run checkError in background.
...
{text: 'OK', onPress: () => console.log('OK Pressed')},
 ...
 { cancelable: false }
  ...
  /* Added by Ryan to run checkError in background.
  componentDidMount() {
